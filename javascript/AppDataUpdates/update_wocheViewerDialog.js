let update_WocheViewerDialog = () => {
    console.log('In update_wocheViewerDialog function')
                        ...
                        if(element.Done === 'true'){
                            divElementsList += 
                                `<div class="todo_ListItem">
                                    ...
                                    <div class="todo_item todoItemJS ${day}">
    ...
    document.querySelector('.Woche_todo_ListWithoutOrdnerJS').innerHTML = divElementsList
    ...
    week.forEach((day)=> {
        ...
        function OrdnerWithTodos(ordner, todos, done, date) {
            this.ordner = ordner;
            this.todos = todos;
            this.done = done;
            this.date = date;
        ...
        uniqueOrdners.forEach( (element) => {
            ...
            todoListWithOrdnersOnly.forEach( (item) => {
                if(item.Ordner === element){
                    ...
                    list03.push(item.Datum)
                }
            })
            let obj = new OrdnerWithTodos(element, list01, list02, list03)
            ...
            for(let i = 0; i<element.todos.length; i++){
                if(element.done[i] === 'true'){
                    ...
                    `<div class="todo_ListItem">
                        ...
                        <div class="todo_item todoItemJS ${element.date[i]}">
                            <div>${element.todos[i]}</div>
                        </div>
                        <div class="todo_deleteDiv">
                            <img src="/images/Papierkorb.svg" alt="" class="todoDeleteDivJS">
                        </div>
    ...
    document.querySelector('.Woche_todo_ListWithOrdnerJS').innerHTML = finalString01
}